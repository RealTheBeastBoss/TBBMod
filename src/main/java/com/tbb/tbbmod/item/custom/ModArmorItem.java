...
import com.tbb.tbbmod.item.ModArmorMaterial;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP = new ImmutableMap.Builder<ArmorMaterial, MobEffect>().put(ModArmorMaterial.BEASTBOSSANIUM, MobEffects.MOVEMENT_SPEED).build();
