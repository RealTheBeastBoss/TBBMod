...
public class Ores {
    public static final int OVERWORLD_AMOUNT = 2; // Spawns on average once every 2 chunks
    public static final int DEEPSLATE_AMOUNT = 1; // Spawns on average once every 1 chunks
